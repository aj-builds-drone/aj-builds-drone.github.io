...
const navLinks = [
  ...
  { href: "/case-studies", label: "CASES", code: "05" },
  { href: "/university-partners", label: "PARTNERS", code: "06" },
  { href: "/roi-calculator", label: "ROI", code: "07" },
  { href: "/contact", label: "RFQ", code: "08" },
];
